...
export const UNITS: Unit[] = [
  ...
  },
  {
    ...
    open: true,
    description:
      "Міжнародний підрозділ спеціального призначення: контртерор, розвідка, евакуація заручників, дії в складних умовах. Єдиний підрозділ Корпусу, відкритий для новачків.",
  },
];
