...
export const UNITS: Unit[] = [
  {
    ...
    open: true,
    description:
      "Група створена та прийнята у складі UKSF у 2023 році.\nХочеш бігати з Юніон Джеком на плечі та епічно розкурювати сігари між бойовими виходами в усіх куточках нашого світу — тобі до нас)\nEverything else — classified until recognition amongst us.\nSee you down range.",
  },
  {
    id: "puma",
    short: "CCO P.U.M.A.",
    ...
    open: true,
    description:
      "Приватна Військова Компанія, заснована ветеранами з усіх куточків світу для заробляння грошей та підтримання правосуддя. Оператори ПВК орієнтуються на серйозну координацію, дисципліну й командну гру у тяжких умовах бою.",
  },
  {
    id: "ion",
    short: "ION",
    ...
    open: true,
    description:
      "Загін ION — міжнародний підрозділ спеціального призначення, створений для виконання складних і відповідальних завдань у сфері безпеки по всій Європі. ION об'єднує людей із різним рівнем досвіду, але зі спільними цінностями — дисципліною, взаємною довірою та командною роботою.",
  },
];
